...
export class UserService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public markWordLearned(username: string, wordId: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public markWordLearned(username: string, wordId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public markWordLearned(username: string, wordId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public markWordLearned(username: string, wordId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (username === null || username === undefined) {
            throw new Error('Required parameter username was null or undefined when calling markWordLearned.');
        }

        if (wordId === null || wordId === undefined) {
            throw new Error('Required parameter wordId was null or undefined when calling markWordLearned.');
        }
        ...
        return this.httpClient.put<any>(`${this.basePath}/user/${encodeURIComponent(String(username))}/${encodeURIComponent(String(wordId))}`,
            null,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
